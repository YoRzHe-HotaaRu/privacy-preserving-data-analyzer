...
from reporting.report_generator import ReportGenerator, HTML_TEMPLATE
from reporting.privacy_certificate import (
...
class TestReportGenerator:
    ...
    def sample_risk_assessment(self):
        ...
        return {
            'overall': {
                ...
                'overall_risk': 0.2,
                'recommendations': [
                    'Consider increasing k-anonymity',
    ...
    def test_generate_html_report_basic(self, sample_data_summary, sample_pii_summary,
                                        sample_privacy_metrics, sample_risk_assessment,
    ...
    def test_report_contains_data_summary(self, sample_data_summary, sample_pii_summary,
                                          sample_privacy_metrics, sample_risk_assessment,
                                          sample_compliance_results):
        """Test that report contains data summary."""
        html = self.generator.generate_html_report(
            sample_data_summary, sample_pii_summary, sample_privacy_metrics,
            sample_risk_assessment, sample_compliance_results
        )
        
        assert '1000' in html or '1,000' in html  # row count
        assert '10' in html  # column count
    
    def test_report_contains_pii_info(self, sample_data_summary, sample_pii_summary,
                                      sample_privacy_metrics, sample_risk_assessment,
                                      sample_compliance_results):
    ...
    def test_report_contains_privacy_metrics(self, sample_data_summary, sample_pii_summary,
                                             sample_privacy_metrics, sample_risk_assessment,
                                             sample_compliance_results):
    ...
    def test_report_contains_compliance_info(self, sample_data_summary, sample_pii_summary,
                                             sample_privacy_metrics, sample_risk_assessment,
                                             sample_compliance_results):
    ...
    def test_report_contains_risk_level(self, sample_data_summary, sample_pii_summary,
                                        sample_privacy_metrics, sample_risk_assessment,
                                        sample_compliance_results):
    ...
    def test_report_with_insights(self, sample_data_summary, sample_pii_summary,
                                  sample_privacy_metrics, sample_risk_assessment,
                                  sample_compliance_results):
    ...
    def test_report_has_valid_html_structure(self, sample_data_summary, sample_pii_summary,
                                             sample_privacy_metrics, sample_risk_assessment,
                                             sample_compliance_results):
    ...
    def test_report_has_styling(self, sample_data_summary, sample_pii_summary,
                                sample_privacy_metrics, sample_risk_assessment,
                                sample_compliance_results):
    ...
    def test_report_id_generated(self, sample_data_summary, sample_pii_summary,
                                 sample_privacy_metrics, sample_risk_assessment,
                                 sample_compliance_results):
    ...
    def test_save_report(self, sample_data_summary, sample_pii_summary,
                         sample_privacy_metrics, sample_risk_assessment,
                         sample_compliance_results):
    ...
    def test_save_report_creates_directory(self, sample_data_summary, sample_pii_summary,
                                           sample_privacy_metrics, sample_risk_assessment,
                                           sample_compliance_results):
    ...
    def test_risk_level_styling(self, sample_data_summary, sample_pii_summary,
                                sample_privacy_metrics, sample_compliance_results):
        ...
        for level in risk_levels:
            ...
            html = self.generator.generate_html_report(
                sample_data_summary, sample_pii_summary, sample_privacy_metrics,
                risk_assessment, sample_compliance_results
            )
...
class TestPrivacyCertificate:
    ...
    def test_generate_privacy_certificate(self, sample_analysis_metadata,
                                          sample_privacy_metrics,
                                          sample_compliance_results):
        """Test privacy certificate generation."""
        certificate = generate_privacy_certificate(
            sample_analysis_metadata,
            sample_privacy_metrics,
            sample_compliance_results
        )
    ...
    def test_certificate_contains_metadata(self, sample_analysis_metadata,
                                           sample_privacy_metrics,
                                           sample_compliance_results):
    ...
    def test_certificate_contains_privacy_params(self, sample_analysis_metadata,
                                                 sample_privacy_metrics,
                                                 sample_compliance_results):
    ...
    def test_certificate_contains_compliance(self, sample_analysis_metadata,
                                             sample_privacy_metrics,
                                             sample_compliance_results):
    ...
    def test_certificate_contains_anonymization_methods(self, sample_analysis_metadata,
                                                        sample_privacy_metrics,
                                                        sample_compliance_results):
    ...
    def test_certificate_has_disclaimer(self, sample_analysis_metadata,
                                        sample_privacy_metrics,
                                        sample_compliance_results):
    ...
    def test_certificate_has_validity_period(self, sample_analysis_metadata,
                                             sample_privacy_metrics,
                                             sample_compliance_results):
    ...
    def test_certificate_format_structure(self, sample_analysis_metadata,
                                          sample_privacy_metrics,
                                          sample_compliance_results):
