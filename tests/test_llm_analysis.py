...
from llm_analysis.prompt_engine import PRIVACY_SYSTEM_PROMPT, PrivacyAwarePromptEngine
...
class TestSafeQueryValidator:
    ...
    @pytest.mark.parametrize(
        "unsafe_keyword", ["specific person", "individual record", "whose email", "find the person", "identify", "ssn"]
    )
