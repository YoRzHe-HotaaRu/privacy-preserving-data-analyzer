...
class TestRiskCalculator:
    ...
    def test_k_anonymity(self, sample_df):
        ...
        result = self.calculator.calculate_k_anonymity(sample_df, quasi_identifiers=["age_range", "gender"])
    ...
    def test_k_anonymity_invalid_columns(self, sample_df):
        ...
        result = self.calculator.calculate_k_anonymity(sample_df, quasi_identifiers=["nonexistent_column"])
    ...
    def test_l_diversity(self, sample_df):
        ...
        result = self.calculator.calculate_l_diversity(
            sample_df, quasi_identifiers=["age_range"], sensitive_attribute="salary"
        )
    ...
    def test_t_closeness(self, sample_df):
        ...
        result = self.calculator.calculate_t_closeness(
            sample_df, quasi_identifiers=["age_range"], sensitive_attribute="city"
        )
    ...
    def test_re_identification_risk(self, sample_df):
        ...
        result = self.calculator.calculate_re_identification_risk(
            sample_df, quasi_identifiers=["age_range", "gender", "city"]
        )
    ...
    def test_all_metrics(self, sample_df):
        ...
        result = self.calculator.calculate_all_metrics(
            sample_df, quasi_identifiers=["age_range", "gender"], sensitive_attribute="salary"
        )
...
class TestComplianceChecker:
    ...
    def sample_privacy_metrics(self):
        ...
        return {"k_anonymity": {"k": 5}, "re_identification": {"overall_risk": 0.1}}

    @pytest.fixture
    def sample_pii_summary(self):
        """Sample PII summary."""
        return {"total_pii": 10, "by_type": {"EMAIL_ADDRESS": {"count": 5}, "PHONE_NUMBER": {"count": 5}}}

    def test_check_gdpr(self, sample_privacy_metrics, sample_pii_summary):
        """Test GDPR compliance check."""
        result = self.checker.check_gdpr(sample_privacy_metrics, sample_pii_summary, anonymization_applied=True)
    ...
    def test_check_hipaa(self, sample_privacy_metrics, sample_pii_summary):
        ...
        result = self.checker.check_hipaa(sample_privacy_metrics, sample_pii_summary, anonymization_applied=True)
    ...
    def test_check_ccpa(self, sample_privacy_metrics, sample_pii_summary):
        ...
        result = self.checker.check_ccpa(sample_privacy_metrics, sample_pii_summary, anonymization_applied=True)
    ...
    def test_check_all(self, sample_privacy_metrics, sample_pii_summary):
        ...
        result = self.checker.check_all(sample_privacy_metrics, sample_pii_summary, anonymization_applied=True)
    ...
    def test_non_compliant_without_anonymization(self, sample_privacy_metrics, sample_pii_summary):
        ...
        result = self.checker.check_gdpr(sample_privacy_metrics, sample_pii_summary, anonymization_applied=False)
