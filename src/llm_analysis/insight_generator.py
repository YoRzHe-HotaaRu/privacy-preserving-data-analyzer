...
class InsightGenerator:
    ...
    def generate_insights(self, df: pd.DataFrame, analysis_type: str = "general") -> Dict[str, Any]:
        """
    ...
    def answer_question(self, df: pd.DataFrame, question: str) -> Dict[str, Any]:
        ...
        return {"question": question, "answer": response, "llm_stats": self.client.get_stats()}
    ...
    def generate_summary(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        return {"summary": response, "data_info": df_summary, "llm_stats": self.client.get_stats()}
