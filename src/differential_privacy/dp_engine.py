...
class DifferentialPrivacyEngine:
    ...
    def laplace_mechanism(self, true_value: Union[float, np.ndarray],
                          sensitivity: float,
                          epsilon: float = None,
                          seed: int = None) -> Union[float, np.ndarray]:
        """
        ...
        self.budget_manager.use_budget('laplace', epsilon, 0, 
            {'sensitivity': sensitivity, 'scale': scale})
        
        return private_value
    
    def gaussian_mechanism(self, true_value: Union[float, np.ndarray],
                          sensitivity: float,
                          epsilon: float = None,
                          delta: float = None,
                          seed: int = None) -> Union[float, np.ndarray]:
        ...
        self.budget_manager.use_budget('gaussian', epsilon, delta,
            {'sensitivity': sensitivity, 'sigma': sigma})
        
        return private_value
    
    def exponential_mechanism(self, options: List[Any],
        ...
        self.budget_manager.use_budget('exponential', epsilon, 0,
            {'num_options': len(options), 'sensitivity': sensitivity})
        
        return selected_option
    
    # ==================== High-Level Query Interface ====================
    
    def private_count(self, data: Union[List, np.ndarray],
    ...
    def private_sum(self, data: Union[List[float], np.ndarray],
                   lower_bound: float,
                   upper_bound: float,
                   epsilon: float = None) -> float:
    ...
    def private_mean(self, data: Union[List[float], np.ndarray],
                    lower_bound: float,
                    upper_bound: float,
                    epsilon: float = None) -> float:
    ...
    def private_histogram(self, data: Union[List, np.ndarray],
    ...
    def private_percentile(self, data: Union[List[float], np.ndarray],
                         percentile: float,
                         lower_bound: float,
                         upper_bound: float,
                         epsilon: float = None) -> float:
    ...
    def private_variance(self, data: Union[List[float], np.ndarray],
                       lower_bound: float,
                       upper_bound: float,
                       epsilon: float = None) -> float:
