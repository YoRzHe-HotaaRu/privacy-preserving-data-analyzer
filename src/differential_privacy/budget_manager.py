...
class PrivacyBudgetManager:
    ...
    def check_budget(self, epsilon: float, delta: float = 0) -> bool:
        ...
        """
        return self.used_epsilon + epsilon <= self.total_epsilon and self.used_delta + delta <= self.total_delta

    def use_budget(self, query_type: str, epsilon: float, delta: float = 0, metadata: Dict[str, Any] = None):
        """
