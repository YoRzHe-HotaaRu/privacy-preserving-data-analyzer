...
class ComplianceChecker:
    ...
    def check_gdpr(self, privacy_metrics: Dict[str, Any],
                  pii_summary: Dict[str, Any],
                  anonymization_applied: bool) -> Dict[str, Any]:
        """
    ...
    def check_hipaa(self, privacy_metrics: Dict[str, Any],
                   pii_summary: Dict[str, Any],
                   anonymization_applied: bool) -> Dict[str, Any]:
        """
    ...
    def check_ccpa(self, privacy_metrics: Dict[str, Any],
                  pii_summary: Dict[str, Any],
                  anonymization_applied: bool) -> Dict[str, Any]:
        """
    ...
    def check_all(self, privacy_metrics: Dict[str, Any],
                 pii_summary: Dict[str, Any],
                 anonymization_applied: bool = True) -> Dict[str, Any]:
        """
